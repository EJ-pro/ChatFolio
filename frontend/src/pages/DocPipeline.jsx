...
const steps = [
  ...
  },
  {
    ...
    detail: null,
    parsers: [
      { lang: "Python", file: "ast_parser.py", tags: ["클래스", "함수", "데코레이터", "임포트"] },
      { lang: "JS/TS/JSX", file: "js_parser.py", tags: ["컴포넌트", "Hooks", "Export"] },
      { lang: "C/C++", file: "cpp_parser.py", tags: ["헤더", "매크로", "네임스페이스"] },
      { lang: "Java", file: "java_parser.py", tags: ["패키지", "인터페이스", "클래스"] },
      { lang: "Kotlin", file: "kotlin_parser.py", tags: ["패키지", "클래스", "메소드"] },
      { lang: "기타/Swift*", file: "generic_extract_metadata", tags: ["기본 메타데이터"], dim: true },
    ],
  },
  {
    id: 5,
    ...
    <div style={{
      ...
      <div style={{ textAlign: "center", marginBottom: 48 }}>
        ...
        <h1 style={{
          ...
          ChatFolio <span style={{ color: "#7DF9C0" }}>파이프라인</span>
        </h1>
