...
function MyPage() {
  ...
  const badges = [
    { id: 'oop', name: '객체지향의 마술사', icon: Sparkles, color: 'text-purple-400', bg: 'bg-purple-500/10' },
    { id: 'deps', name: '의존성 관리의 달인', icon: GitBranch, color: 'text-blue-400', bg: 'bg-blue-500/10' },
    { id: 'clean', name: '클린 코드 전도사', icon: ShieldCheck, color: 'text-emerald-400', bg: 'bg-emerald-500/10' },
  ];
        ...
        <section className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1 glass-panel rounded-3xl p-8 border border-white/10 relative overflow-hidden flex flex-col items-center text-center">
            ...
            <div className="flex flex-wrap justify-center gap-2 mb-8">
              {badges.map(badge => (
                <div key={badge.id} className={`${badge.bg} ${badge.color} px-3 py-1.5 rounded-xl text-xs font-bold flex items-center gap-1.5 border border-white/5 shadow-inner`}>
