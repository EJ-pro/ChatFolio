...
- **👤 사용자 맞춤형 프로필**: 활동 국가 및 직급 정보를 기반으로 최적화된 기술 분석과 페르소나 리포트를 제공합니다.
...
- **📝 다국어 README (KR/EN)**: 한국어와 영어 중 원하는 언어를 선택하거나, 두 언어를 동시에 지원하는 README를 한 번에 생성할 수 있습니다.
...
Step 03  📡 Scan            재귀 디렉토리 순회, .md/.txt 등 기존 문서 배제 및 코드 위주 필터링
 ...
 Step 05  ✂️ Chunking        RecursiveCharacterTextSplitter를 이용한 의미 단위 코드 분할
    ↓
 Step 06  🔢 Embedding       HuggingFace all-MiniLM-L6-v2 기반 로컬 벡터 변환
    ↓
